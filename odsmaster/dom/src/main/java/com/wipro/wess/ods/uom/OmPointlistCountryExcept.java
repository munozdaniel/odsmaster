...
/**
 * OmPointlistCountryExcept generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_pointlist_country_except", objectIdClass = OmPointlistCountryExceptPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_pointlistcountryexcept_by_user", language = "JPQL", value = "SELECT pointlistCountryExcept FROM com.wipro.wess.ods.uom.OmPointlistCountryExcept pointlistCountryExcept "
        + " JOIN pointlistCountryExcept.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmPointlistCountryExcept")
public class OmPointlistCountryExcept implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = -2320247613549412007L;
    ...
    public OmPointlistCountryExcept() {
    }

    public OmPointlistCountryExcept(int rowseqId, Date changedate) {
        this.rowseqId = rowseqId;
        this.changedate = changedate;
    }

    public OmPointlistCountryExcept(MUnitFamily MUnitFamily, MUnit MUnit, int rowseqId, String state0, String state1,
            String changeby, Date changedate, Long sourceId) {
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmPointlistCountryExcept> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.pointListService.listAllUOMPointlistCountryExcept();
