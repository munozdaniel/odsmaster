...
/**
 * OmPointlistSiteExcept generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_pointlist_site_except", objectIdClass = OmPointlistSiteExceptPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_pointlistsiteexcept_by_user", language = "JPQL", value = "SELECT pointlistSiteExcept FROM com.wipro.wess.ods.uom.OmPointlistSiteExcept pointlistSiteExcept "
        + " JOIN pointlistSiteExcept.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmPointlistSiteExcept")
public class OmPointlistSiteExcept implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = 2855842993666012250L;
    ...
    public OmPointlistSiteExcept() {
    }

    public OmPointlistSiteExcept(MPointlist pointList, int rowseqId, Date changedate) {
        this.pointList = pointList;
        this.rowseqId = rowseqId;
        this.changedate = changedate;
    }

    public OmPointlistSiteExcept(MPointlist pointList, MUnitFamily MUnitFamily, MUnit MUnit, int rowseqId,
            String state0, String state1, String changeby, Date changedate, Long sourceId) {
        this.pointList = pointList;
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmPointlistSiteExcept> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.pointListService.listAllUOMPointlistSiteExcept();
