...
/**
 * OmAssetInputservice generated by hbm2java
 */
@Named("AssetInputservice")
@Bookmarkable
@Audited
@ObjectType("OmAssetInputservice")
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_asset_inputservice", objectIdClass = OmAssetInputservicePK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({
        @javax.jdo.annotations.Query(name = "fetch_OmAssetInputservice_by_pk", language = "JDOQL", value = "SELECT "
                + " OmAssetInputservice FROM com.wipro.wess.ods.asset.servicemapping.OmAssetInputservice OmAssetInputservice WHERE orgId == :orgId && assetUid == :assetUid && "
                + " inputserviceAssetUid == :inputserviceAssetUid"),
        @javax.jdo.annotations.Query(name = "fetch_input_services_by_user", language = "JPQL", value = "SELECT service FROM com.wipro.wess.ods.asset.servicemapping.OmAssetInputservice service "
...
public class OmAssetInputservice implements java.io.Serializable, InstanceCallbacks {
    ...
    private OmServiceConfig inputserviceAssetUid;
    ...
    public OmAssetInputservice() {
    }

    public OmAssetInputservice(int rowseqId, Date changedt) {
        this.rowseqId = rowseqId;
        this.changedt = changedt;
    }

    public OmAssetInputservice(int rowseqId, String monitoringAssetUid, String description, Long sourceId,
    ...
    @Column(allowsNull = "false", name = "inputservice_asset_uid")
    @Title
    @Persistent(primaryKey = "true")
    public OmServiceConfig getInputserviceAssetUid() {
        return inputserviceAssetUid;
    }

    public void setInputserviceAssetUid(OmServiceConfig inputserviceAssetUid) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OmAssetInputservice other = (OmAssetInputservice) obj;
        if (assetUid == null) {
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmAssetInputservice> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.assetServiceMappingService.listAllAssetInputServices();
