...
/**
 * OmPointlistCountryExceptAudit generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_pointlist_country_except_audit", objectIdClass = OmPointlistCountryExceptAuditPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_pointlistcountryexceptaudit_by_user", language = "JPQL", value = "SELECT pointlistCountryExceptAudit FROM com.wipro.wess.ods.uom.OmPointlistCountryExceptAudit pointlistCountryExceptAudit "
        + " JOIN pointlistCountryExceptAudit.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmPointlistCountryExceptAudit")
public class OmPointlistCountryExceptAudit implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = 4369394176697293321L;
    ...
    public OmPointlistCountryExceptAudit() {
    }

    public OmPointlistCountryExceptAudit(int rowseqId, MOrganisation orgId, String locCountryUid, MPointlist pointList,
            Date changedate) {
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmPointlistCountryExceptAudit> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.pointListService.listAllUOMPointlistCountryExceptAudit();
