...
/**
 * OmPointlistCountryPolicy generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_pointlist_country_policy", objectIdClass = OmPointlistCountryPolicyPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_pointlistcountrypolicy_by_user", language = "JPQL", value = "SELECT pointlistCountryPolicy FROM com.wipro.wess.ods.uom.OmPointlistCountryPolicy pointlistCountryPolicy "
        + " JOIN pointlistCountryPolicy.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmPointlistCountryPolicy")
public class OmPointlistCountryPolicy implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = -5329691883331437878L;
    ...
    public OmPointlistCountryPolicy() {
    }

    public OmPointlistCountryPolicy(MPointlist pointList, int rowseqId, Date changedate, String datapointtype) {
    ...
    public OmPointlistCountryPolicy(MPointlist pointList, MUnitFamily MUnitFamily, MUnit MUnit, int rowseqId,
            String state0, String state1, String changeby, Date changedate, Long sourceId, BigDecimal discardPassLow,
            BigDecimal discardPassHigh, String description, String datapointtype) {
        this.pointList = pointList;
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmPointlistCountryPolicy> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.pointListService.listAllUOMPointlistCountryPolicy();
