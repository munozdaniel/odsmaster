...
/**
 * OmUomCountryPolicyAudit generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_uom_country_policy_audit", objectIdClass = UomCountryPolicyAuditPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_uomcountrypolicyaudit_by_user", language = "JPQL", value = "SELECT countryPolicyAudit FROM com.wipro.wess.ods.uom.OmUomCountryPolicyAudit countryPolicyAudit "
        + " JOIN countryPolicyAudit.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmUomCountryPolicyAudit")
public class OmUomCountryPolicyAudit implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = -7334279499853820226L;
    ...
    public OmUomCountryPolicyAudit() {
    }

    public OmUomCountryPolicyAudit(int recordId, MOrganisation orgId, String locCountryId,
    ...
    public OmUomCountryPolicyAudit(int recordId, MOrganisation orgId, String locCountryId,
            MMeasurementEntity measureEntityId, MMeasurement measureId, MUnitFamily unitFamilyId, MUnit unitId,
            Date changeDate, String action, Long sourceId) {
        this.recordId = recordId;
        this.orgId = orgId;
        this.locCountryId = locCountryId;
        this.measureEntityId = measureEntityId;
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmUomCountryPolicyAudit> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.uomService.listAllUOMCountryPoliciyAudits();
