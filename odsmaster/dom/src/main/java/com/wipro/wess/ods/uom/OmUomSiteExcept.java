...
/**
 * OmUomSiteExcept generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_uom_site_except", objectIdClass = OmUomSiteExceptPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_uomsiteexcept_by_user", language = "JPQL", value = "SELECT uomSiteExcept FROM com.wipro.wess.ods.uom.OmUomSiteExcept uomSiteExcept "
        + " JOIN uomSiteExcept.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmUomSiteExcept")
public class OmUomSiteExcept implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = 5250820786047338077L;
    ...
    public OmUomSiteExcept() {
    }

    public OmUomSiteExcept(MUnitFamily MUnitFamily, MUnit MUnit, int recordId, Date changeDate) {
    ...
    public OmUomSiteExcept(MUnitFamily MUnitFamily, MUnit MUnit, int recordId, Date changeDate, Long sourceId) {
        this.MUnitFamily = MUnitFamily;
        this.MUnit = MUnit;
        this.recordId = recordId;
        this.changeDate = changeDate;
