...
/**
 * OmUomOrgPolicy generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_uom_org_policy", objectIdClass = OmUomOrgPolicyPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_uomorgpolicy_by_user", language = "JPQL", value = "SELECT uomOrgPolicy FROM com.wipro.wess.ods.uom.OmUomOrgPolicy uomOrgPolicy "
        + " JOIN uomOrgPolicy.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmUomOrgPolicy")
public class OmUomOrgPolicy implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = 5930008035130288190L;
    ...
    public OmUomOrgPolicy() {
    }

    public OmUomOrgPolicy(MUnitFamily MUnitFamily, MUnit MUnit, int recordId, Date changeDate) {
    ...
    public OmUomOrgPolicy(MUnitFamily MUnitFamily, MUnit MUnit, int recordId, Date changeDate, Long sourceId,
            String measureAlias) {
        this.MUnitFamily = MUnitFamily;
        this.MUnit = MUnit;
        this.recordId = recordId;
