...
/**
 * OmAssetOutputserviceId generated by hbm2java
 */
public class OmAssetOutputservicePK implements java.io.Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -2066131539647008951L;
    ...
    public ServiceConfigPK outputserviceAssetUid;

    public OmAssetOutputservicePK() {
    }

    public OmAssetOutputservicePK(OrganisationPK orgId, OmAssetPK assetUid, ServiceConfigPK outputserviceAssetUid) {
        this.orgId = orgId;
        this.assetUid = assetUid;
        this.outputserviceAssetUid = outputserviceAssetUid;
    }

    public OmAssetOutputservicePK(String key) {
        ...
        this.outputserviceAssetUid = new ServiceConfigPK(token.nextToken());
    }

    @Override
    public String toString() {
        return encode(this.orgId.toString() + "-" + this.assetUid.toString() + "-"
                + this.outputserviceAssetUid.toString());
    }
    ...
    public ServiceConfigPK getOutputserviceAssetUid() {
        return outputserviceAssetUid;
    }

    
    public void setOutputserviceAssetUid(ServiceConfigPK outputserviceAssetUid) {
        this.outputserviceAssetUid = outputserviceAssetUid;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (outputserviceAssetUid == null) {
            if (other.inputserviceAssetUid != null)
                return false;
        } else if (!outputserviceAssetUid.equals(other.inputserviceAssetUid))
            return false;
        if (orgId == null) {
            if (other.orgId != null)
                return false;
