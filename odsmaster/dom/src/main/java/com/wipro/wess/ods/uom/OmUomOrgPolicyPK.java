...
/**
 * OmUomOrgPolicyId generated by hbm2java
 */
public class OmUomOrgPolicyPK implements java.io.Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 3994834555385449928L;
    ...
    public OmUomOrgPolicyPK() {
    }

    public OmUomOrgPolicyPK(OrganisationPK orgId, MeasurementEntityPK measureEntityId, MeasurementPK measureId) {
        this.orgId = orgId;
        this.measureEntityId = measureEntityId;
        this.measureId = measureId;
    }

    public OmUomOrgPolicyPK(String key) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OmUomOrgPolicyPK other = (OmUomOrgPolicyPK) obj;
