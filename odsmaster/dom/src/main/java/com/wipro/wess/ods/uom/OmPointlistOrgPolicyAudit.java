...
/**
 * OmPointlistOrgPolicyAudit generated by hbm2java
 */
@javax.jdo.annotations.PersistenceCapable(schema = "gemsods", table = "om_pointlist_org_policy_audit", objectIdClass = OmPointlistCountryPolicyAuditPK.class, identityType = IdentityType.APPLICATION)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "fetch_pointlistorgpolicyaudit_by_user", language = "JPQL", value = "SELECT pointlistOrgPolicyAudit FROM com.wipro.wess.ods.uom.OmPointlistOrgPolicyAudit pointlistOrgPolicyAudit "
        + " JOIN pointlistOrgPolicyAudit.orgId organization WHERE EXISTS "
...
@Audited
@Bookmarkable
@ObjectType("OmPointlistOrgPolicyAudit")
public class OmPointlistOrgPolicyAudit implements java.io.Serializable, InstanceCallbacks {

    /**
     * 
     */
    private static final long serialVersionUID = 5252189565423917658L;
    ...
    public OmPointlistOrgPolicyAudit() {
    }

    public OmPointlistOrgPolicyAudit(int rowseqId, MOrganisation orgId, MPointlist pointList, String datapointtype,
            Date changedate) {
    ...
    public OmPointlistOrgPolicyAudit(int rowseqId, MOrganisation orgId, MPointlist pointList, String description,
            String datapointtype, String unitId, String unitFamilyId, String state0, String state1, String changeby,
    ...
    @Bulk
    @CssClass("x-caution")
    public List<OmPointlistOrgPolicyAudit> delete() {
        this.container.removeIfNotAlready(this);
        this.container.informUser("Deleted " + container.titleOf(this));
        return this.pointListService.listAllUOMPointlistOrgPolicyAudit();
