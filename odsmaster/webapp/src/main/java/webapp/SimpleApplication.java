    ...
    protected Module newIsisWicketModule() {
        ...
        final Module quickstartOverrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("applicationName")).toInstance("ODS Master Data Management");
                ...
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("odsmaster");
